...
if (isset($_GET['id'])) {
	$idReponse=$_GET['id'];
	$req="delete from reponse where numRep='$idReponse'";
...
<header class="topbar">
  ...
  <nav>
    ...
    <a href="reponses.php"  class="active"><i class="fas fa-comments"></i> الردود</a>
...
<body>
 ...
 <form class="filter-bar mb-3" method="GET" style="gap: 18px;">
    ...
    <div class="form-group mb-0 d-flex align-items-center" style="margin-right:auto; min-width:180px;">
        <a href="ajoutReponse.php" class="btn btn-ajout"
           ...
           <i class="fas fa-plus-circle" style="margin-left:6px;"></i> إضافة رد                                    
        </a>
    </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover align-middle table-striped">
						...
						$numR=$_GET['numR'];
						$req = "SELECT numR, reclamant.reclamant, numRep, dateRep, resume, remarque FROM reclamant, reclamation, reponse 
						...
						$res=listerReponse($reclamant);		
                          ...
                          foreach ($res as $row) {
							...
							echo "<td><a href='detailsReponse.php?id=" . $row['numR'] . "' class='btn-outline-secondary' title='تفاصيل'><i class='fas fa-info-circle'></i></a></td>";
                              echo "<td>
							  <a href='reponses.php?id=".$row['numRep']."' class='btn-action delete' title='حذف' onclick=\"return confirm('هل أنت متأكد أنك تريد حذف هذه الإجابة؟');\">
							  <i class='fas fa-trash-alt'></i>
								</a></td>";
                              echo "<td><a href='modifReponse.php?id=".$row['numRep']."' class='btn-action' title='تعديل'><i class='fas fa-pen'></i></a></td>";
                              echo "</tr>";
							}}
                          ?>
                        </tbody>
